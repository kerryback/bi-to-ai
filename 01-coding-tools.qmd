...
Ask the agent to create a chart.  Does it follow your instructions?  Modify the instruction file and ask again.  The deliverable is your instruction file and a brief note on what the agent followed and what it ignored.
:::
