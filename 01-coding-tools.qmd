...
Streamlit builds simple web apps from Python scripts --- you write a short script and Streamlit turns it into an interactive page.  The `openai` package is a Python client for OpenAI-compatible APIs, which includes OpenRouter (described next).  Later chapters mention additional packages as needed.
...
1. Sign up at [openrouter.ai](https://openrouter.ai) using a Google or GitHub account.
