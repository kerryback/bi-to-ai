...
Download Python 3.10 or later from [python.org](https://www.python.org/downloads/).  On Windows, check **"Add Python to PATH"** during installation.  On Mac, you can also install via Homebrew with `brew install python`.  After installing, verify by opening a terminal and running:
