...
Download the app files here: [chinook-query.py](files/code/chinook-query.py) and [requirements.txt](files/code/requirements.txt).  Copy `chinook.db` into the same folder, install the dependencies, and run:
...
Download the chart app files here: [chinook-charts.py](files/code/chinook-charts.py) and [requirements.txt](files/code/requirements.txt).  Copy `chinook.db` into the same folder, install the dependencies, and run:
