...
Download the app files here: [app.py](files/code/chinook-query/app.py) and [requirements.txt](files/code/chinook-query/requirements.txt).  Copy `chinook.db` into the same folder, install the dependencies, and run:
...
Download the chart app files here: [app.py](files/code/chinook-charts/app.py) and [requirements.txt](files/code/chinook-charts/requirements.txt).  Copy `chinook.db` into the same folder, install the dependencies, and run:
