...
Open the recommendation memo you wrote in Chapter 2 (or re-run the Superstore analysis using [superstore.csv](files/data/superstore.csv)).  Give the memo to Claude and ask it to find the three weakest claims.
...
Open the retention memo you wrote in Chapter 2 Exercise 3 (or re-run the attrition analysis using [employee-attrition.csv](files/data/employee-attrition.csv)).  Give the memo to Claude and work through three thinking-partner moves.
