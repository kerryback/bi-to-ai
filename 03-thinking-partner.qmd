...
Chapter 2 showed how AI can analyze data in minutes.  But many of the hardest decisions in business are not data problems --- they are thinking problems.  The data may be clear, but the implications are not.  The options are not fully explored.  The assumptions are unchallenged.  The failure modes are unexamined.

This chapter is about using AI as a sparring partner: someone who will argue with you, challenge your preferred option, and surface the assumptions you did not know you were making.
...
The most powerful conversations blend Chapter 2 analysis with Chapter 3 thinking moves.

"Here's my Chapter 2 memo.  Find the three weakest claims."  This takes the Superstore recommendation you built in the previous chapter and subjects it to adversarial scrutiny.
...
Bring your Chapter 2 analysis and ask AI to poke holes in it.  Open your recommendation memo and ask:
...
The deliverable is the conversation transcript plus a five-sentence reflection, one per move.
:::

::: {.callout-note title="Exercise 2: Challenge Your Chapter 2 Analysis" collapse="true"}
Open the recommendation memo you wrote in Chapter 2 (or re-run the Superstore analysis using [superstore.csv](data/superstore.csv)).  Give the memo to Claude and ask it to find the three weakest claims.
...
Open the retention memo you wrote in Chapter 2 Exercise 3 (or re-run the attrition analysis using [employee-attrition.csv](data/employee-attrition.csv)).  Give the memo to Claude and work through three thinking-partner moves.
...
Revise your memo to acknowledge the strongest counterargument.  The deliverable is the original memo, the thinking-partner conversation, and the revised memo.
:::

::: {.callout-note title="Exercise 4: Scenario Swap" collapse="true"}
If you are working through this book with a colleague, write down a real business decision you are facing in one or two sentences.  Swap scenarios.  Have a thinking-partner conversation about your colleague's scenario using at least three of the five conversation moves.

Share back: "Here's what AI surfaced about your decision."  It is often easier to be objective about someone else's problem.  The deliverable is two key insights for your partner.
:::
...
Revise the proposal to address the top two concerns.  The deliverable is the original proposal, the stakeholder reactions, and the revised proposal.
:::
