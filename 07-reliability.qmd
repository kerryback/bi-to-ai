...
First, sanity-check: open the [Superstore data](data/superstore.csv) in your coding agent and ask three questions where you know the answer (row count, total revenue, number of unique customers).  Does AI match?
...
Open your coding agent with the [Chinook database](data/chinook.db) and your SKILL.md from Chapter 4.
...
Open your coding agent with the [company handbook](data/company-handbook.md) from Chapter 6 and ask five factual questions.
