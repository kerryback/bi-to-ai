...
Chapter 6 uses a [sample company handbook](files/data/company-handbook.md) for RAG exercises.

## Prerequisites

You need the Claude Desktop app installed on your machine.  Chapter 1 walks through installation and introduces the **Code** tab --- the interface we use throughout this book.  No prior coding or data science experience is assumed.

The examples use Claude Code via the Desktop app, but the concepts and workflows apply equally to alternative coding agents like Gemini CLI and OpenAI Codex, which Chapter 1 also describes.
