...
Chapter 1 introduced the coding agents and showed how to install them.  Now it is time to use one.  This chapter goes from a raw spreadsheet to a written recommendation with charts in under ten minutes --- using nothing but plain-English conversation.
