...
Notice the last line of the prompt: logging.  Every LLM request and response is written to a JSONL file with timestamps.  This creates an audit trail --- you can see exactly what the LLM was asked and what it returned.  Module 8 will use these logs for verification and governance.
