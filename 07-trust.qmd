...
The deliverable is a one-page verification report with pass or fail for each step.
:::
...
For each failure, diagnose the root cause, fix the SKILL.md, and retest.  The deliverable is a hardened SKILL.md and a log of your five adversarial queries with outcomes.
:::
...
The deliverable is your citation audit log with ratings and your out-of-scope test results.
:::
...
The deliverable is the one-page policy.
:::
...
The deliverable is a one-page compliance scenario analysis.
:::
