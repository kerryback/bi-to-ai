...
Download the [sample company handbook](data/company-handbook.md) and place it in a folder.  Open your coding agent in that folder.  Then ask questions:
...
Download the [company handbook](data/company-handbook.md) and place it in a folder.  Open your coding agent in that folder and ask five questions about the content.
...
The deliverable is your five questions with evaluation ratings and your two out-of-scope test results.
:::

::: {.callout-note title="Exercise 2: Citation Verification" collapse="true"}
Ask three questions about the [company handbook](data/company-handbook.md) and get answers with citations.
...
The deliverable is three answers with citation verification notes.
:::

::: {.callout-note title="Exercise 3: Conflicting Sources" collapse="true"}
Create a second version of the [company handbook](data/company-handbook.md) in which you change one or two facts (for example, change the PTO accrual rates or the return policy window).  Place both versions in the same folder.

Ask a question where the two versions disagree.  Does AI cite both?  Pick one?  Acknowledge the conflict?

This simulates a common production problem: stale documents coexisting with current ones.  The deliverable is the question, AI's answer, and your assessment of how it handled the conflict.
:::

::: {.callout-note title="Exercise 4: RAG vs. Direct Reading" collapse="true"}
Ask your coding agent to read the entire [company handbook](data/company-handbook.md) as one document and answer a question (this is the direct-context approach).  Then ask the same question in a way that forces chunked retrieval (for example, by placing many documents in the folder so the handbook is too large for the context window to hold in full).
...
The deliverable is the one-page proposal.
:::
