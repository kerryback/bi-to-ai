...
Chapter 3 showed how AI can analyze data in minutes.  But many of the hardest decisions in business are not data problems --- they are thinking problems.  The data may be clear, but the implications are not.  The options are not fully explored.  The assumptions are unchallenged.  The failure modes are unexamined.
...
The most powerful conversations blend Chapter 3 analysis with Chapter 4 thinking moves.

"Here's my Chapter 3 memo.  Find the three weakest claims."  This takes the Superstore recommendation you built in the previous chapter and subjects it to adversarial scrutiny.
...
Bring your Chapter 3 analysis and ask AI to poke holes in it.  Open your recommendation memo and ask:
...
::: {.callout-note title="Exercise 2: Challenge Your Chapter 3 Analysis" collapse="true"}
Open the recommendation memo you wrote in Chapter 3 (or re-run the Superstore analysis using [superstore.csv](files/data/superstore.csv)).  Give the memo to Claude and ask it to find the three weakest claims.
...
Open the retention memo you wrote in Chapter 3 Exercise 3 (or re-run the attrition analysis using [employee-attrition.csv](files/data/employee-attrition.csv)).  Give the memo to Claude and work through three thinking-partner moves.
